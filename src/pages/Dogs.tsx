    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="flex justify-between items-center mb-10">
                <div>
                    <h1 className="text-3xl font-extrabold text-gray-900 dark:text-white">Registered Champions</h1>
                    <p className="mt-2 text-gray-600 dark:text-gray-400">Meet the amazing dogs competing in our show</p>
                </div>
            ...
            {error ? (
                ...
                <div className="text-center py-20 bg-gray-50 dark:bg-gray-800/50 rounded-2xl">
                    <DogIcon className="h-16 w-16 text-gray-300 dark:text-gray-600 mx-auto mb-4" />
                    <h3 className="text-xl font-medium text-gray-900 dark:text-white">No dogs registered yet</h3>
                    <p className="mt-2 text-gray-500 dark:text-gray-400">Be the first to register a champion!</p>
                </div>
            ) : (
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    {dogs.map((dog) => (
                        <div key={dog.id} className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transition-shadow overflow-hidden border border-gray-100 dark:border-gray-700 group">
                            ...
                            <div className="p-6 space-y-4">
                                ...
                                <div className="pt-4 border-t border-gray-100 dark:border-gray-700 flex gap-3">
                                    <div className="flex-1">
                                        ...
                                        <p className="text-sm text-gray-700 dark:text-gray-300 truncate">{dog.pedigree}</p>
                                    </div>
                                    <Link
                                        to="/apply"
                                        state={{ dogId: dog.id }}
