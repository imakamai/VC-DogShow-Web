...
import { Menu, X, Dog, User, LogOut, Sun, Moon } from 'lucide-react';
...
const Navbar = () => {
    ...
    return (
        <nav className="fixed w-full z-50 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-b border-white/20 dark:border-gray-800 shadow-lg transition-colors duration-300">
                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="hidden lg:block">
                        <div className="ml-4 flex items-center md:ml-6 gap-4">
                            <button
                                onClick={toggleTheme}
                                className="p-2 rounded-lg text-gray-500 hover:text-orange-500 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-orange-400 dark:hover:bg-gray-800 transition-all"
                            ...
                            {isAuthenticated ? (
                                <div className="flex items-center gap-4">
                                    <Link to="/profile" className="text-gray-800 dark:text-gray-100 hover:text-orange-500 p-1 rounded-full">
                    ...
                    <div className="-mr-2 flex lg:hidden">
                        <button
                            ...
                            className="inline-flex items-center justify-center p-2 rounded-md text-gray-800 dark:text-gray-100 hover:text-orange-500 focus:outline-none"
                        >
                    ...
                    <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                        ...
                        <div className="pt-4 border-t border-gray-100 dark:border-gray-800 mt-2">
                            <button
                                ...
                                className="w-full flex items-center justify-center gap-2 px-3 py-2 rounded-md text-base font-medium text-gray-800 dark:text-gray-200 hover:text-orange-500 hover:bg-gray-50 dark:hover:bg-gray-800"
                            >
                                {theme === 'light' ? (
                                    <>
